...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/maicotm86/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/maicotm86/arch-dwm/master/progs.csv"
...
finalize(){ \
        dialog --infobox "Cleaning Instalation..." 4 50
...
putgitrepo "$dotfilesrepo" "/home/$name" "$repobranch" || error "Failed to install dotfiles"
